// Pure tier-1 / tier-3 / signal-expansion alert rule evaluator.
// No I/O — takes a `MetricsPayload` and returns `AlertEvalResult[]`.
 ...
 */
export function evaluateRules(payload: MetricsPayload): AlertEvalResult[] {
