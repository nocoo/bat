      ...
      <div className="flex flex-col items-center">
        ...
        >
          ...
          <div className="flex flex-col items-center px-6 pt-8 pb-6">
            ...
            <p className="mt-1 text-xs text-muted-foreground">Sign in to access the monitoring dashboard</p>

            {/* Error message */}
            {error && (
              <div className="mt-3 w-full rounded-lg bg-destructive/10 px-3 py-2 text-xs text-destructive text-center">
                {error === "AccessDenied"
                  ? "Sorry, your account is not authorized to access this application."
          ...
          <div className="flex items-center justify-center border-t border-border bg-secondary/50 py-2.5">
            <div className="flex items-center gap-1.5">
              ...
              <span className="text-[10px] text-muted-foreground">Secure connection</span>
            </div>
          </div>
        </div>
      </div>
